...
contract Blood{
    ...
    address payable public admin = address(0x74B6aCeBA25a317cBb21E46146693A139332A7c6);
    address payable public hospi = address(0x519656B8a37D2C6F5B8022fEF151f6a4e871b9ce);
    ...
    constructor() public{
        name = "Pranav Gor";
        userCount ++;
        usertype[admin] = User(userCount, 14, "Admin", admin, "Muhammad Aamir Khan", '', '', "Dera Ismail Khan");
        users[userCount] = User(userCount, 14, "Admin", admin, "Muhammad Aamir Khan", '', '', "Dera Ismail Khan");
    }
