...
class App extends Component {
  ...
  async loadBlockchainData() {
   ...
   // console.dir(window.web3.currentProvider)  for printing objects
  // console.dir(Blood.networks)
   // console.log("Check Blood.networks[5777] " + Blood.networks[5777])
    const networkData = Blood.networks[networkId]
    console.log("executed this line")
   // const networkData = Blood.networks[5777]
 //   console.log("check networkData "+networkData)
  //  console.dir(networkData) 
    if(networkData) {
      const blood = new web3.eth.Contract(Blood.abi, networkData.address)
    //  console.log("this is const blood " + blood)
     // console.dir(blood)
      this.setState({ blood })
      ...
      console.log("this is .toNumber " + account_type)
      console.dir(account_type)
        this.setState({ acc_type: account_type.user_type })
      }
